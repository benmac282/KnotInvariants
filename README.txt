...
no two separate arcs can touch; the knot must be one link (one closed loop); no two crossings can overlap/be on top of one another; and the under-arc in a crossing is drawn with gaps slightly before there would have been an intersection
